...
export default post({
  title: "Use Next.js and MDX",
  description:
    "I'm switching from plain HTML to using Next.js and MDX to have better ease of writing and extensibility.",
...
[started my blog dead simple in plain HTML](hello-world). Although I had a fun
time writing blog posts in HTML and had
[an interesting Aha! movement](hello-world), writing plain HTML created quite a
few boilerplates.
...
To prevent myself from procrastinating, I
[started my blog dead simple in plain HTML](hello-world). Although I had a fun
time writing blog posts in `HTML` and had an
[interesting Aha! movement](hello-world), writing plain `HTML` created quite a
few boilerplates.
```
...
<p>
  To prevent myself from procrastinating, I
  <a href="hello-world">started my blog dead simple in plain HTML</a>. Although
  I had a fun time writing blog posts in <code>HTML</code> and had
  <a href="hello-world">an interesting Aha! movement</a>, writing plain
  <code>HTML</code> creates quite a few boilerplates.
</p>
```
