...
exports.readBlog = exports.postIsntNil = exports.getBlogFiles = exports.readPost = exports.postExporter = exports.postParser = exports.generatePostCover = exports.isPost = exports.getPostPath = exports.postFolders = exports.postFrontmatterSchema = void 0;
...
const isPost = (folder, slug) => exports.postFolders.includes(folder) && slug.length > 0;
exports.isPost = isPost;
const generatePostCover = (cover, title) => {
    if (cover && cover.url)
...
const postParser = () => (tree, file) => {
    ...
    if (!exports.isPost(folder, slug))
        return file.message("Not a post, skip.");
    const data = remark_1.getVFileData(file);
    const { frontmatter } = data;
    if (!frontmatter)
        return file.fail("No frontmatter.");
    const validation = revalidator_1.default.validate(frontmatter, exports.postFrontmatterSchema);
    if (!validation.valid)
    ...
    data.post = {
        ...
        cover: exports.generatePostCover(frontmatter.cover, title),
        path: relURL,
        folder,
        slug,
    };
