...
exports.readBlog = exports.postIsntNil = exports.getBlogFiles = exports.readPost = exports.postExtracter = exports.getPostPath = void 0;
...
exports.postExtracter = postExtracter;
const readPost = (absPath) => {
    const file = remark_1.reader().use(exports.postExtracter).processSync(remark_1.toVFile(absPath));
