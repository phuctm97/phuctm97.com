...
exports.readBlog = exports.postIsntNil = exports.getBlogFiles = exports.readPost = exports.postExporter = exports.postParser = exports.getPostPath = exports.postSchema = void 0;
...
const mdParser = remark_1.createParser(exports.postSchema);
const mdReader = remark_1.createReader(mdParser);
const readPost = (absPath) => {
    const file = mdReader().use(exports.postParser).processSync(remark_1.toVFile(absPath));
    const { post } = remark_1.getVFileData(file);
    return post;
};
