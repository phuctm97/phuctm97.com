...
const md_processor_1 = require("../packages/md-processor");
...
const readPost = (absPath) => {
    const file = md_processor_1.mdReader().use(exports.postParser).processSync(to_vfile_1.default.readSync(absPath));
    const { post } = file.data;
    return post;
};
